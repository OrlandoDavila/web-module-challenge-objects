...
console.log(createMenuItem('Rice', 05, 'Lunch'));
console.log(createMenuItem('Tacos', 10, 'Breakfast'));
...
reviews.push({name:"Orlando",rating:6,feedback:"I guess this was ok. Who am I to judge"})
